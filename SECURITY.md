...
1. **Email**: [Bilal140202@users.noreply.github.com](mailto:Bilal140202@users.noreply.github.com) (or use GitHub's private vulnerability reporting on the Security tab).
...
3. **Prefer canonical ⭐** — Canonical representatives have been vetted by the dedup algorithm (see [DEDUP.md](DEDUP.md)). They're not guaranteed to be safe, but they're the best version that we have found.
...
- **No secrets in code** — The crawler reads `GITHUB_TOKEN` from the environment only. No hardcoded credentials.
